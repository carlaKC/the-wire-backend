...
— J.`,
				Heuristics: []heuristic{
					...
					{Name: "ideology_or_incentives", Signal: "negative", Rating: "low", Description: "Reads as a routine procedural escalation; no agenda or personal incentive evident."},
				},
			},
			{
				ID:       2,
...
This invoice is confidential and should not be shared with audit.`,
				Heuristics: []heuristic{
					...
					{Name: "ideology_or_incentives", Signal: "negative", Rating: "low", Description: "No advocacy framing; the document presents itself as a routine billing artifact."},
				},
			},
		},
	},
...
— A.`,
				Heuristics: []heuristic{
					...
					{Name: "ideology_or_incentives", Signal: "negative", Rating: "medium", Description: "Direct request to move discussion off email and 'tidy' PO records suggests an evasive incentive rather than neutral reporting."},
				},
			},
		},
	},
...
Office of the General Counsel`,
				Heuristics: []heuristic{
					...
					{Name: "ideology_or_incentives", Signal: "negative", Rating: "low", Description: "No advocacy framing or personal incentive evident; reads as a routine compliance disclosure."},
				},
			},
		},
	},
