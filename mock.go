	...
	Topics: []topicSummary{
		{
			...
			Triage:      "high",
			Description: "Documents reference off-book payments to Atlas Holdings and Northbridge Consulting that lack standard procurement approvals. Triage: high because impact is high and evidence quality is medium.",
		},
		{
			ID:          2,
			Title:       "Internal communications",
			Triage:      "medium",
			Description: "Email correspondence between staff discussing the Atlas payments and proposing to move further conversations off-record. Triage: medium because impact is medium and evidence quality is medium.",
		},
		{
			ID:          3,
			Title:       "External correspondence",
			Triage:      "low",
			Description: "Formal disclosures to external compliance auditors stating no off-book arrangements exist. Triage: low because impact is low and evidence quality is medium.",
		},
	},
}
...
var mockTopicDetails = map[int]topicDetailResponse{
	1: {
		...
		Topic: topicDetail{
			...
			Heuristics: []topicHeuristic{
				{Name: "impact", Rating: "high", Description: "Impact: The topic describes off-book payments and missing procurement approvals. Evidence quality is medium."},
				...
				{Name: "claims", Rating: "high", Description: "Rated high because the topic contains many extracted factual claims."},
				{Name: "validation", Rating: "medium", Description: "Rated medium because one or more claims could not be clearly verified."},
	...
	2: {
		...
		Topic: topicDetail{
			...
			DocumentCount: 1,
			Heuristics: []topicHeuristic{
				{Name: "impact", Rating: "medium", Description: "Impact: The topic describes internal handling of payment concerns. Evidence quality is medium."},
				{Name: "evidence_quality", Rating: "medium", Description: "Evidence quality used to gate final topic triage."},
				{Name: "sensitivity", Rating: "medium", Description: "Rated medium because the topic includes moderately sensitive material."},
	...
	3: {
		...
		Topic: topicDetail{
			...
			DocumentCount: 1,
			Heuristics: []topicHeuristic{
				{Name: "impact", Rating: "low", Description: "Impact: The topic is lower priority without corroborating claims in this mock case. Evidence quality is medium."},
				{Name: "evidence_quality", Rating: "medium", Description: "Evidence quality used to gate final topic triage."},
				{Name: "sensitivity", Rating: "low", Description: "Rated low because the topic does not exceed the low sensitivity band."},
				{Name: "claims", Rating: "low", Description: "Rated low because no factual claims were extracted for this topic."},
...
— J.`,
				...
				FactsToVerify: []string{
					"Three off-cycle disbursements were processed in March–April 2025 to Atlas Holdings ($147,500 on 2025-03-22, $89,200 on 2025-04-02) and Northbridge Consulting ($212,000 on 2025-04-09).",
					"PO #84221 is recorded for the $212,000 Northbridge Consulting payment, while the two Atlas Holdings payments have no PO on file.",
...
This invoice is confidential and should not be shared with audit.`,
				...
				FactsToVerify: []string{
					"Atlas Holdings invoice 2025-Q1-final totals $162,500 covering Jan–Mar 2025, with a $62,500 line item described as 'Special project (off-book)'.",
					"The invoice instructs that it 'should not be shared with audit'.",
				},
			},
		},
	},
...
— A.`,
				...
				FactsToVerify: []string{
					"Email between alice@example.com and bob@example.com on 2025-04-10 references a finance-team inquiry into the Atlas payments.",
					"The email proposes moving further conversations to an unnamed 'encrypted channel' and asks for PO records to be 'tidied' before a follow-up the next week.",
				},
			},
		},
	},
...
Office of the General Counsel`,
				...
				FactsToVerify: []string{
					"A March 28, 2025 letter to the Office of the Compliance Auditor states that no off-book arrangements exist between the company and any third party in which an officer holds a beneficial interest.",
					"The letter is signed by the Office of the General Counsel as part of the annual disclosure under Section 14B for fiscal year 2024.",
				},
			},
		},
	},
